                                            ...
                                            <td>
                                                <div class="action-dots ">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-end">
                                                        <li><a class="dropdown-item" href="{{ route("detailJobPage",$savedJob->job_id) }}"> <i class="fa fa-eye" aria-hidden="true"></i> View</a></li>
    ...
    if (confirm("Are you sure you want to remove?")) {
        $.ajax({
            ...
            success: function(response) {
                window.location.href='{{ route("saveJobPage") }}';
            }
        });
    } 
}
